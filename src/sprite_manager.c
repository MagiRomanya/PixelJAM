...
void destroyAssets() {
    ...
    UnloadTexture(assetsContainer.sprites[SPRITE_SWITCH_OFF_ID]);
    UnloadTexture(assetsContainer.sprites[SPRITE_SWITCH_ON_STAGE1_ID]);
    UnloadTexture(assetsContainer.sprites[SPRITE_SWITCH_ON_STAGE2_ID]);
